...
const ContactSection: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Formspree will automatically handle the submission
    setIsSubmitted(true);
  };
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        {isSubmitted ? (
          <motion.div
            ...
            className="text-center text-cosmic-blue"
          >
          ...
          <motion.form
            ...
            action="https://formspree.io/f/mvgoreal" // Replace with your Formspree endpoint
            method="POST"
          ...
          >
            <div>
              ...
              <input
                type="text"
                id="name"
                name="name" // This is required for Formspree
            ...
            <div>
              ...
              <input
                type="email"
                id="email"
                name="email" // This is required for Formspree
            ...
            <div>
              ...
              <textarea
                id="message"
                name="message" // This is required for Formspree
